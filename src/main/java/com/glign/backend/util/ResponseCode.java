...
public enum ResponseCode {
    ...
    LOGOUT_PROBLEM(HttpStatus.INTERNAL_SERVER_ERROR.value(), Constant.LOGOUT_PROBLEM),
    ...
    NAME_IS_REQUIRED(HttpStatus.PRECONDITION_REQUIRED.value(), Constant.NAME_IS_REQUIRED);
