...
-- Tabla users
CREATE TABLE IF NOT EXISTS users (id BIGINT PRIMARY KEY, uuid UUID NOT NULL, name VARCHAR(255) NOT NULL,
...
-- Tabla phones
CREATE TABLE IF NOT EXISTS phones (id BIGINT PRIMARY KEY, phone_number VARCHAR(20) NOT NULL,
